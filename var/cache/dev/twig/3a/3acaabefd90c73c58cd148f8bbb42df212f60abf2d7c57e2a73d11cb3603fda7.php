...
class __TwigTemplate_c93a4aa5677daf4a1ef80bd1a8d586bf12f9543126bfe370df11ce8f6b238678 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "img_project_name", [], "any", false, false, false, 10), 'row');
        echo "
";
        // line 11
...
<a class=\"btn btn-primary\" href=\"";
    ...
    {
        return array (  112 => 15,  105 => 11,  101 => 10,  97 => 9,  93 => 7,  83 => 6,  63 => 3,  53 => 6,  50 => 5,  48 => 3,  45 => 2,);
    }
...
{{ form_start(form) }}
    {{ form_row(form.img_project_name) }}
{{ form_end(form) }}

<button class=\"btn btn-primary btn-sm\" type=\"submit\">Sauvegarder</button>

<a class=\"btn btn-primary\" href=\"{{ path('app_admin') }}\">Revenir au Menu principal</a>{% endblock %}", "project/create.html.twig", "/var/www/ProjetPortfolio/templates/project/create.html.twig");
    }
}
