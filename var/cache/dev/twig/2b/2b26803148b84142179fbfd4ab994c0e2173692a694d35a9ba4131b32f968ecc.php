...
class __TwigTemplate_adda60348dfd1e3731566de2a07896975ed95ee25b9a06b98f5addd9f6fdf888 extends Template
{
    private $source;
    private $macros = [];
...
\t\t<ul>
\t\t\t<li>
\t\t\t\t<a href=\"{{ path('app_admin_project') }}\">Projets</a>
\t\t\t</li>
\t\t\t<li>
\t\t\t\t<a href=\"{{ path('app_admin_skill') }}\">Compétences</a>
\t\t\t</li>
\t\t\t<li>
\t\t\t\t<a href=\"{# {{ path('app_admin_info') }} #}\">Veilles</a>
\t\t\t\t{# <ul>
\t\t\t\t\t<li>Informatique</li>
\t\t\t\t\t<li>Juridique</li>
\t\t\t\t</ul> #}
...
\t</form>
{% endblock %}
", "admin/index.html.twig", "/var/www/ProjetPortfolio/templates/admin/index.html.twig");
    }
}
