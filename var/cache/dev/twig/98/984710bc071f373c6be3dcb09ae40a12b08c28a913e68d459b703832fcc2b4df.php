...
class __TwigTemplate_8dc9f499822017afd403b1e5002558754d818e88801c9042a1a3fe138e3edbfb extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 9, $this->source); })()), "user", [], "any", false, false, false, 9)) {
            ...
            Autres : ";
            // line 13
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "telephone", [], "any", false, false, false, 13), "html", null, true);
            echo " - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "address", [], "any", false, false, false, 13), "html", null, true);
            echo " - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "city", [], "any", false, false, false, 13), "html", null, true);
            echo ",
            ";
            // line 15
            echo "        </div>   
...
";
    ...
    {
        return array (  135 => 21,  132 => 20,  128 => 19,  124 => 18,  120 => 16,  116 => 15,  108 => 13,  102 => 12,  98 => 11,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Connecté en tant que : {{ app.user.email }}, <br>
            Nom: {{ app.user.firstname }} {{ app.user.name }}, <br>
            Autres : {{ app.user.telephone }} - {{ app.user.address }} - {{ app.user.city }},
...
{% endblock %}", "admin/index.html.twig", "/var/www/ProjetPortfolio/templates/admin/index.html.twig");
    }
}
