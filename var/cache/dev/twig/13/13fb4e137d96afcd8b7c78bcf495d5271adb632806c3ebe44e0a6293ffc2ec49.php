...
class __TwigTemplate_d5ae8e30582a7ba10902ddbcbe5ab0ebe3fd93786b8556b876657ab4ab3a3504 extends Template
{
    private $source;
    private $macros = [];
...
<button class=\"btn btn-primary\" type=\"submit\">Sauvegarder</button>
<a class=\"btn btn-primary\" href=\"{{ path('app_admin_skill') }}\">Revenir à la liste</a>
<a class=\"btn btn-primary\" href=\"{{ path('app_admin') }}\">Revenir au Menu principal</a>
{{ form_end(form) }}

{% endblock %}", "skill/create.html.twig", "/var/www/ProjetPortfolio/templates/skill/create.html.twig");
    }
}
