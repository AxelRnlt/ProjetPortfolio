...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AccountFixtures(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\RoleFixtures(), 'groups' => []]]);
