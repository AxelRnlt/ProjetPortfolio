...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/AccountFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AccountFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []]]);
    ...
    protected function getSecurity_Command_UserPasswordEncoderService()
    {
        ...
        $this->privates['security.command.user_password_encoder'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\UserPasswordEncoderCommand(($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()), [0 => 'App\\Entity\\Account']);
    ...
    protected function getSecurity_User_Provider_Concrete_AppUserProviderService()
    {
        ...
        return $this->privates['security.user.provider.concrete.app_user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Account', 'name', NULL);
    }
